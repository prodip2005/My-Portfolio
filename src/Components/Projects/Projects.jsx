        ...
        <section id="projects" className="relative py-32 bg-transparent overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="mb-20 flex flex-col md:flex-row md:items-end justify-between gap-8">
                    <div className="text-left relative overflow-visible px-4 py-2">
                        <motion.h2
                            initial={{ opacity: 0, x: -20 }}
                            whileInView={{ opacity: 1, x: 0 }}
                            viewport={{ once: true }}
                            className="text-4xl md:text-6xl lg:text-8xl font-black text-white uppercase tracking-tighter leading-[1.2] flex flex-wrap items-center gap-x-4"
                        >
                            MY
                            <span className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600 italic py-2 pr-6">
                                PROJECTS
                            </span>
                        </motion.h2>
                        ...
                        <motion.div
                            ...
                            className="h-1.5 bg-cyan-500 mt-2 rounded-full shadow-[0_0_15px_rgba(34,211,238,0.5)] ml-1"
                        />
                    </div>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-12">
                                    ...
                                    <div className="lg:col-span-5 p-8 lg:p-12 bg-white/[0.02] border-r border-white/10">
                                        <div className="relative group mb-8">
                                            <img src={selectedProject.image} alt="" className="w-full rounded-3xl border border-white/5 shadow-2xl transition-transform duration-500 group-hover:scale-[1.02]" />
                                    ...
                                    <div className="lg:col-span-7 p-10 lg:p-16">
                                        <div className="flex justify-between items-start mb-12">
                                            ...
                                            <button onClick={() => setSelectedProject(null)} className="p-3 bg-white/5 rounded-full text-white hover:bg-red-500/20 transition-all hover:rotate-90">
                                                <X size={20} />
                                            </button>
                                        </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="flex flex-wrap gap-3">
                                                    {selectedProject.tech.map(t => (
                                                        <span key={t} className="px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-white/70 text-[10px] font-bold uppercase tracking-widest">{t}</span>
                                                    ))}
                                                </div>
                                            </div>
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <div className="p-8 rounded-[2rem] bg-red-500/5 border border-red-500/10 transition-colors">
                                                ...
                                                <div className="p-8 rounded-[2rem] bg-cyan-500/5 border border-cyan-500/10 transition-colors">
